...
const EmployeeHeader = () => {
  ...
  return (
    <header className="h-[72px] bg-card border-b border-border flex items-center justify-between px-6 relative z-50">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Login Button */}
        <button className="px-6 py-2.5 rounded-full border-2 border-primary text-primary font-bold text-sm hover:bg-primary hover:text-primary-foreground transition-all active:scale-[0.98]">
          Log ind
        </button>
      </div>
    </header>
